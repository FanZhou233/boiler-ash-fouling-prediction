"""Normalized script generated from data_prediction_TiDE+WOA.py."""
...
def objective_func(solution):
    ...
    try:
        model = TiDEModel(
            ...
            num_encoder_layers=2,  # Tunable parameter.
            num_decoder_layers=2,  # Tunable parameter.
            dropout=0.1,
            n_epochs=10,
...
history = []  # Run the optimization process.
...
print("Best error (MAPE):", g_best.target.fitness)
...
history_df.to_csv("tide_optimization_history.csv", index=False, encoding="utf-8-sig")
print("Optimization history saved to tide_optimization_history.csv")
...
df_result.to_csv("tide_prediction_result.csv", encoding="utf-8-sig")
print("Prediction results saved to tide_prediction_result.csv")
