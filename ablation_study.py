...
def main() -> None:
    parser = argparse.ArgumentParser(description="生成论文风格的中文消融实验图。")
    parser.add_argument(
        "--plot",
